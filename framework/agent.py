...
class Agent:
    ...
    def _get_system_message(self) -> str:
        ...
        return (
            ...
            "Use guides to define terms and required business logic in the user's "
            "question. Do not add extra filters, exclusions, grouping rules, or "
            "category mappings from a guide unless the prompt asks for them or the "
            "guide explicitly says they always apply.\n\n"
            "Use execute_query to inspect distinct values, sample rows, or draft "
            "formula outputs when a filter value, threshold, encoded value, or "
            "metric definition is ambiguous.\n\n"
            "For list/show entity queries, include natural descriptive fields such "
            "as names, types, categories, dates, statuses, percentages, or locations "
            "when they do not change the row count, grouping grain, or business "
            "meaning of the query.\n\n"
            "Before submit_answer, verify that the requested filters, metric "
            "formula, grouping grain, row entity, and selected columns match the "
            "prompt and any applicable guide rules.\n\n"
